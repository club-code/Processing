...
const val RANDOM_DIRECTION = 1f / 3
const val RANDOM_CONTINUE = 1f / 2
...
class Program : PApplet() {
    ...
    override fun setup() {
        colors = listOf(
            PVector(255f, 0f, 0f), PVector(255f, 255f, 255f), PVector(255f, 255f, 0f),
            PVector(0f, 0f, 255f)
        )
        mouseClicked()
    }
